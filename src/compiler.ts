...
export class FHIRPathCompiler {
  ...
  private compileLiteral(node: LiteralNode): CompiledLiteralNode {
    ...
    return {
      ...node,
      eval: function evalLiteral(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileIdentifier(node: IdentifierNode): CompiledIdentifierNode {
    ...
    return {
      ...node,
      eval: function evalIdentifier(context: any[], data: any, ctx: EvaluationContext): any[] {
        ...
        const fhirTypes = new Set([
          ...
          'Bundle', 'OperationOutcome', 'Parameters', 'Group', 'Person',
          'RelatedPerson', 'Specimen', 'Substance', 'ValueSet', 'CodeSystem'
        ]);
  ...
  private compileDot(node: DotNode): CompiledDotNode {
    ...
    return {
      ...
      left: compiledLeft,
      right: compiledRight,
      eval: function evalDot(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileBinary(node: BinaryOpNode): CompiledBinaryOpNode {
    ...
    switch (node.op) {
      ...
      case TokenType.PLUS:
        evalFn = function evalPlus(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case TokenType.MINUS:
        evalFn = function evalMinus(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.MULTIPLY:
        evalFn = function evalMultiply(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.DIVIDE:
        evalFn = function evalDivide(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.DIV:
        evalFn = function evalDiv(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.MOD:
        evalFn = function evalMod(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.EQUALS:
        evalFn = function evalEquals(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.NOT_EQUALS:
        evalFn = function evalNotEquals(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.LESS_THAN:
        evalFn = function evalLessThan(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.GREATER_THAN:
        evalFn = function evalGreaterThan(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
          ...
          if (typeof l === 'number' && typeof r === 'object' && r !== null && 'value' in r && 'unit' in r) {
      ...
      case TokenType.LESS_EQUALS:
        evalFn = function evalLessEquals(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.GREATER_EQUALS:
        evalFn = function evalGreaterEquals(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      // Logical operators
      case TokenType.AND:
        evalFn = function evalAnd(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
      ...
      case TokenType.OR:
        evalFn = function evalOr(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          if (left.length === 0) {
      ...
      case TokenType.IMPLIES:
        evalFn = function evalImplies(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          if (left.length === 0) return [];
      ...
      case TokenType.XOR:
        evalFn = function evalXor(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.PIPE:
        evalFn = function evalUnion(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
          return [...left, ...right];
        };
      ...
      case TokenType.IN:
        evalFn = function evalIn(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
      ...
      case TokenType.CONTAINS:
        evalFn = function evalContains(context: any[], data: any, ctx: EvaluationContext): any[] {
          const left = compiledLeft.eval(context, data, ctx);
          const right = compiledRight.eval(context, data, ctx);
  ...
  private compileUnary(node: UnaryOpNode): CompiledUnaryOpNode {
    ...
    switch (node.op) {
      case TokenType.PLUS:
        evalFn = function evalUnaryPlus(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case TokenType.MINUS:
        evalFn = function evalUnaryMinus(context: any[], data: any, ctx: EvaluationContext): any[] {
          const operand = compiledOperand.eval(context, data, ctx);
          if (operand.length !== 1 || typeof operand[0] !== 'number') return [];
          return [-operand[0]];
        };
      ...
      case TokenType.NOT:
        evalFn = function evalNot(context: any[], data: any, ctx: EvaluationContext): any[] {
          const operand = compiledOperand.eval(context, data, ctx);
  ...
  private compileFunction(node: FunctionCallNode): CompiledFunctionCallNode {
    ...
    switch (node.name) {
      case 'where':
        evalFn = function evalWhere(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'select':
        evalFn = function evalSelect(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
      ...
      case 'exists':
        evalFn = function evalExists(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'empty':
        evalFn = function evalEmpty(context: any[], data: any, ctx: EvaluationContext): any[] {
          return [context.length === 0];
        };
        break;
        
      case 'count':
        evalFn = function evalCount(context: any[], data: any, ctx: EvaluationContext): any[] {
          return [context.length];
        };
        break;
        
      case 'first':
        evalFn = function evalFirst(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.length > 0 ? [context[0]] : [];
        };
        break;
        
      case 'last':
        evalFn = function evalLast(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.length > 0 ? [context[context.length - 1]] : [];
        };
        break;
        
      case 'tail':
        evalFn = function evalTail(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.slice(1);
        };
        break;
        
      case 'take':
        evalFn = function evalTake(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
      ...
      case 'skip':
        evalFn = function evalSkip(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
          const n = compiledArgs[0].eval(context, data, ctx);
          if (n.length !== 1 || typeof n[0] !== 'number') return [];
      ...
      case 'distinct':
        evalFn = function evalDistinct(context: any[], data: any, ctx: EvaluationContext): any[] {
          const seen = new Set();
          const result = [];
      ...
      case 'all':
        evalFn = function evalAll(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
          const predicate = compiledArgs[0];
      ...
      case 'any':
        evalFn = function evalAny(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
          const predicate = compiledArgs[0];
      ...
      // String functions
      case 'length':
        evalFn = function evalLength(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'startsWith':
        evalFn = function evalStartsWith(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
      ...
      case 'endsWith':
        evalFn = function evalEndsWith(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
      ...
      case 'contains':
        evalFn = function evalContainsFunc(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
      ...
      case 'substring':
        evalFn = function evalSubstring(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'upper':
        evalFn = function evalUpper(context: any[], data: any, ctx: EvaluationContext): any[] {
          // Handle collections
          return context.map(item => {
      ...
      case 'lower':
        evalFn = function evalLower(context: any[], data: any, ctx: EvaluationContext): any[] {
          // Handle collections
          return context.map(item => {
            // Check if the item can be converted to string meaningfully
            if (typeof item === 'number' && compiledArgs.length === 0) {
      ...
      case 'replace':
        evalFn = function evalReplace(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'trim':
        evalFn = function evalTrim(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (context.length !== 1) return [];
      ...
      case 'split':
        evalFn = function evalSplit(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'join':
        evalFn = function evalJoin(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 1) return [];
          const separator = compiledArgs[0].eval(context, data, ctx);
          if (separator.length !== 1) return [];
      ...
      case 'sum':
        evalFn = function evalSum(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'toString':
        evalFn = function evalToString(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (context.length !== 1) return [];
      ...
      case 'toInteger':
        evalFn = function evalToInteger(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (context.length !== 1) return [];
          const val = context[0];
      ...
      case 'iif':
        evalFn = function evalIif(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (compiledArgs.length !== 3) {
            throw new Error('iif() requires exactly 3 arguments: condition, true-result, false-result');
          }
          
          // Evaluate the condition
          const condition = compiledArgs[0].eval(context, data, ctx);
          if (condition.length !== 1 || typeof condition[0] !== 'boolean') {
            throw new Error('iif() condition must evaluate to a single boolean');
          }
      ...
      // Math functions
      case 'abs':
        evalFn = function evalAbs(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
            if (typeof item !== 'number') {
      ...
      case 'ceiling':
        evalFn = function evalCeiling(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
            if (typeof item !== 'number') {
              throw new Error('Math functions require numeric input');
            }
      ...
      case 'floor':
        evalFn = function evalFloor(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
            if (typeof item !== 'number') {
              throw new Error('Math functions require numeric input');
            }
      ...
      case 'round':
        evalFn = function evalRound(context: any[], data: any, ctx: EvaluationContext): any[] {
          // Check if precision is provided
          let precision = 0;
          if (compiledArgs.length > 0) {
            const precisionResult = compiledArgs[0].eval(context, data, ctx);
            if (precisionResult.length === 1 && typeof precisionResult[0] === 'number') {
      ...
      case 'sqrt':
        evalFn = function evalSqrt(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
            if (typeof item !== 'number') {
              throw new Error('Math functions require numeric input');
            }
      ...
      case 'div':
        evalFn = function evalDiv(context: any[], data: any, ctx: EvaluationContext): any[] {
          ...
          if (divisorResult.length !== 1 || typeof divisorResult[0] !== 'number') {
      ...
      // Date/Time functions
      case 'now':
        evalFn = function evalNow(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'today':
        evalFn = function evalToday(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'timeOfDay':
        evalFn = function evalTimeOfDay(context: any[], data: any, ctx: EvaluationContext): any[] {
      ...
      case 'type':
        evalFn = function evalType(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
            ...
            if (typeof item === 'string') {
              ...
              if (item.match(/^\d{4}-\d{2}-\d{2}T/)) return { name: 'DateTime' };
              if (item.match(/^\d{4}(-\d{2}(-\d{2})?)?$/)) return { name: 'Date' };
      ...
      case 'max':
        evalFn = function evalMax(context: any[], data: any, ctx: EvaluationContext): any[] {
          ...
          for (let i = 1; i < context.length; i++) {
            ...
            if (typeof max === 'string' && typeof current === 'string' && 
                isTemporalValue(max) && isTemporalValue(current)) {
      ...
      case 'min':
        evalFn = function evalMin(context: any[], data: any, ctx: EvaluationContext): any[] {
          if (context.length === 0) return [];
          ...
          for (let i = 1; i < context.length; i++) {
            const current = context[i];
            // Handle temporal values with special comparison
            if (typeof min === 'string' && typeof current === 'string' && 
                isTemporalValue(min) && isTemporalValue(current)) {
      ...
      case 'value':
        evalFn = function evalValue(context: any[], data: any, ctx: EvaluationContext): any[] {
          return context.map(item => {
      ...
      default:
        ...
        evalFn = function evalGeneric(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileIndexer(node: IndexerNode): CompiledIndexerNode {
    ...
    return {
      ...
      expr: compiledExpr,
      index: compiledIndex,
      eval: function evalIndexer(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileAsType(node: AsTypeNode): CompiledAsTypeNode {
    ...
    return {
      ...
      eval: function evalAsType(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileIsType(node: IsTypeNode): CompiledIsTypeNode {
    ...
    return {
      ...node,
      expression: compiledExpression,
      eval: function evalIsType(context: any[], data: any, ctx: EvaluationContext): any[] {
  ...
  private compileVariable(node: VariableNode): CompiledVariableNode {
    ...
    return {
      ...node,
      eval: function evalVariable(context: any[], data: any, ctx: EvaluationContext): any[] {
        switch (name) {
          case 'this':
            return context;
          case 'index':
  ...
  private compileEnvironmentVariable(node: EnvironmentVariableNode): CompiledEnvironmentVariableNode {
    const name = node.name;
    
    return {
      ...node,
      eval: function evalEnvironmentVariable(context: any[], data: any, ctx: EvaluationContext): any[] {
        switch (name) {
          case 'resource':
  ...
  private compileNullLiteral(node: NullLiteralNode): CompiledNullLiteralNode {
    return {
      ...node,
      eval: function evalNull(context: any[], data: any, ctx: EvaluationContext): any[] {
