...
describe('User-defined functions', () => {
  test('should parse simple user-defined function calls', () => {
    ...
    expect(ast.right.name).toBe('myCustomFunction');
    expect(ast.right.args).toHaveLength(0);
  });
  ...
  test('should parse user-defined functions with arguments', () => {
    ...
    expect(ast.right.args[0].kind).toBe('identifier');
    expect(ast.right.args[0].name).toBe('given');
    expect(ast.right.args[1].kind).toBe('identifier');
    expect(ast.right.args[1].name).toBe('family');
  });
  ...
  test('should parse user-defined functions with complex arguments', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('processName');
    expect(ast.right.args).toHaveLength(2);
    
    // First argument is a function call
    expect(ast.right.args[0].kind).toBe('dot');
    expect(ast.right.args[0].right.kind).toBe('function');
    expect(ast.right.args[0].right.name).toBe('first');
    
    // Second argument is a binary expression
    expect(ast.right.args[1].kind).toBe('binary');
    expect(ast.right.args[1].left.kind).toBe('dot');
    expect(ast.right.args[1].right.kind).toBe('literal');
  });
  ...
  test('should parse camelCase user-defined functions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('calculateBMI');
  });
  ...
  test('should parse snake_case user-defined functions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('get_full_name');
  });
  ...
  test('should parse user-defined functions with numeric suffixes', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('getValue2');
  });
  ...
  test('should parse user-defined functions at root level', () => {
    ...
    expect(ast.name).toBe('myGlobalFunction');
    expect(ast.args).toHaveLength(2);
    expect(ast.args[0].kind).toBe('identifier');
    expect(ast.args[0].name).toBe('Patient');
    expect(ast.args[1].kind).toBe('identifier');
    expect(ast.args[1].name).toBe('Observation');
  });
  ...
  test('should parse chained user-defined functions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('formatOutput');
    
    expect(ast.left.kind).toBe('dot');
    expect(ast.left.right.kind).toBe('function');
    expect(ast.left.right.name).toBe('anotherTransform');
    
    expect(ast.left.left.kind).toBe('dot');
    expect(ast.left.left.right.kind).toBe('function');
    expect(ast.left.left.right.name).toBe('customTransform');
  });
  ...
  test('should parse user-defined functions mixed with built-in functions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('first');
    
    // Check the customFormat function
    expect(ast.left.kind).toBe('dot');
    expect(ast.left.right.kind).toBe('function');
    expect(ast.left.right.name).toBe('customFormat');
  });
  ...
  test('should parse user-defined functions with literals as arguments', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('customAge');
    expect(ast.right.args).toHaveLength(4);
    
    expect(ast.right.args[0].kind).toBe('literal');
    expect(ast.right.args[0].value).toBe(18);
    expect(ast.right.args[1].kind).toBe('literal');
    expect(ast.right.args[1].value).toBe('years');
    expect(ast.right.args[2].kind).toBe('literal');
    expect(ast.right.args[2].value).toBe(true);
    expect(ast.right.args[3].kind).toBe('literal');
  ...
  test('should parse user-defined functions with date/time arguments', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('calculateAge');
    expect(ast.right.args).toHaveLength(2);
    
    expect(ast.right.args[0].kind).toBe('literal');
    expect(ast.right.args[0].dataType).toBe('date');
    expect(ast.right.args[1].kind).toBe('literal');
    expect(ast.right.args[1].dataType).toBe('datetime');
  });
  ...
  test('should parse user-defined functions with variables', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('customProcess');
    expect(ast.right.args).toHaveLength(2);
    
    expect(ast.right.args[0].kind).toBe('variable');
    expect(ast.right.args[0].name).toBe('this');
    expect(ast.right.args[1].kind).toBe('envVariable');
    expect(ast.right.args[1].name).toBe('resource');
  });
  ...
  test('should parse user-defined functions in indexer expressions', () => {
    ...
    expect(ast.index.kind).toBe('function');
    expect(ast.index.name).toBe('customPredicate');
  });
  ...
  test('should parse user-defined functions with lambda-like expressions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('customWhere');
    expect(ast.right.args).toHaveLength(1);
    expect(ast.right.args[0].kind).toBe('binary');
  });
  ...
  test('should handle reserved words that look like custom functions', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('existsCustom');
    
    ast = parse('Patient.myExists()');
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('myExists');
  });
  ...
  test('should parse very long user-defined function names', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('thisIsAVeryLongUserDefinedFunctionNameThatShouldStillParse');
  });
  ...
  test('should parse user-defined functions with quantity arguments', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('convertUnit');
    expect(ast.right.args).toHaveLength(2);
    
    expect(ast.right.args[0].kind).toBe('literal');
    expect(ast.right.args[0].dataType).toBe('quantity');
    expect(ast.right.args[0].value).toBe("80 'kg'");
  });
  ...
  test('should parse nested user-defined function calls', () => {
    ...
    expect(ast.kind).toBe('dot');
    expect(ast.right.kind).toBe('function');
    expect(ast.right.name).toBe('outerFunction');
    expect(ast.right.args).toHaveLength(2);
    
    expect(ast.right.args[0].kind).toBe('function');
    expect(ast.right.args[0].name).toBe('innerFunction');
    expect(ast.right.args[0].args).toHaveLength(2);
  });
});